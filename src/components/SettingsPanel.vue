    ...
    <div class="settings-panel">
      ...
      <div class="panel-content" v-if="loaded">
        ...
        <div v-if="provider === 'minimax'" class="provider-panel">
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <button class="toggle-btn" @click="showKey = !showKey">
                <svg v-if="showKey" width="16" height="16" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M1 7s2.5-4 6-4 6 4 6 4-2.5 4-6 4-6-4-6-4z" />
                  <circle cx="7" cy="7" r="2" />
                </svg>
                <svg v-else width="16" height="16" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M1 7s2.5-4 6-4 6 4 6 4-2.5 4-6 4-6-4-6-4z" />
                  <circle cx="7" cy="7" r="2" />
                  <path d="M2 12L12 2" />
                </svg>
          ...
          <div class="form-group">
            <label>模型</label>
            <select v-model="model" class="model-select" @change="syncContextWindow">
              <option value="MiniMax-M3">MiniMax-M3 (1,000,000)</option>
...
import { setUserContextWindow } from '../composables/useAgentConversation'
...
const model = ref('MiniMax-M3')
const customApiUrl = ref('')
const customApiKey = ref('')
const customModel = ref('')
const contextWindow = ref(1000000)
...
function syncContextWindow() {
  contextWindow.value = model.value === 'MiniMax-M3' ? 1000000 : 204800
}
...
const loadSettings = async () => {
  try {
    ...
    setUserContextWindow(provider.value === 'custom' ? customContextWindow.value : contextWindow.value)
